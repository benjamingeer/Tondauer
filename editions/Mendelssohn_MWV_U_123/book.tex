...
\begin{center}
  ...
  \vspace{4.6 cm}
  {\footnotesize Version 0.6, 2021-04-02} \\
  \vspace{0.1 cm}
...
\ifdef{\critical}
  {% Text for the critical edition
    ...
    Roskell\footnote{\url{https://peneloperoskell.co.uk}} for her
    ...
    Je remercie Penelope
    Roskell\footnote{\url{https://peneloperoskell.co.uk}} pour ses
